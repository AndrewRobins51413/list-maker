    ...
    return (
      <form onSubmit={this.handleAdd} onReset={this.handleCancel}>
        <div className="input-group mb-3">
          ...
          <input type="text" className="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" alue={this.state.name} placeholder="Name" onChange={this.handleNameChange}></input>
        </div>
        <div className="input-group mb-3">
          <div className="input-group-prepend">
          ...
          <input type="text" className="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
            lue={this.state.course} placeholder="Course" onChange={this.handleCourseChange}></input>
        </div>
        <div className="input-group mb-3">
          <div className="input-group-prepend">
          ...
          <input type="number" className="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
            ue={this.state.grade} placeholder="Grade" onChange={this.handleGradeChange}></input>
        </div>
